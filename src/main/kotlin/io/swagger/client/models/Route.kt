...
import io.swagger.client.models.Waypoint
 ...
 * @param createdAt The time at which the route was created
 * @param updatedAt The time at which the route was last updated
 * @param estimatedMovingTime Estimated time in seconds for the authenticated athlete to complete route
 * @param segments The segments traversed by this route
 * @param waypoints The custom waypoints along this route
 */
data class Route (
