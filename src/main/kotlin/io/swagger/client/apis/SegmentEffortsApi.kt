...
class SegmentEffortsApi(basePath: kotlin.String = "https://www.strava.com/api/v3") : ApiClient(basePath) {
    ...
    */
    ...
    fun getEffortsBySegmentId(segmentId: kotlin.Int, startDateLocal: java.time.LocalDateTime, endDateLocal: java.time.LocalDateTime, perPage: kotlin.Int) : kotlin.Array<DetailedSegmentEffort> {
