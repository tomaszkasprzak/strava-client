...
public class StreamsApiTest {
     ...
     */
    @Test
    public void getRouteStreamsTest() throws Exception {
        Long id = null;
     ...
     */
    @Test
    public void getSegmentEffortStreamsTest() throws Exception {
        Long id = null;
        List<String> keys = null;
        Boolean keyByType = null;
     ...
     */
    @Test
    public void getSegmentStreamsTest() throws Exception {
        Long id = null;
        List<String> keys = null;
        Boolean keyByType = null;
