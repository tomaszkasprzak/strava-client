...
public class ActivitiesApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getCommentsByActivityIdCall(Long id, Integer page, Integer perPage, Integer pageSize, String afterCursor, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getCommentsByActivityIdValidateBeforeCall(Long id, Integer page, Integer perPage, Integer pageSize, String afterCursor, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCommentsByActivityIdCall(id, page, perPage, pageSize, afterCursor, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Comment> getCommentsByActivityId(Long id, Integer page, Integer perPage, Integer pageSize, String afterCursor) throws ApiException {
        ApiResponse<List<Comment>> resp = getCommentsByActivityIdWithHttpInfo(id, page, perPage, pageSize, afterCursor);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Comment>> getCommentsByActivityIdWithHttpInfo(Long id, Integer page, Integer perPage, Integer pageSize, String afterCursor) throws ApiException {
        com.squareup.okhttp.Call call = getCommentsByActivityIdValidateBeforeCall(id, page, perPage, pageSize, afterCursor, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCommentsByActivityIdAsync(Long id, Integer page, Integer perPage, Integer pageSize, String afterCursor, final ApiCallback<List<Comment>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCommentsByActivityIdValidateBeforeCall(id, page, perPage, pageSize, afterCursor, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Comment>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
